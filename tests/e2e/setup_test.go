...
import (
	...
	apiclientv1 "github.com/keepcalmist/chat-service/tests/e2e/api/client/v1"
	clientchat "github.com/keepcalmist/chat-service/tests/e2e/client-chat"
	wsstream "github.com/keepcalmist/chat-service/tests/e2e/ws-stream"
)
