...
import (
	...
	types "github.com/keepcalmist/chat-service/internal/types"
)
...
func (m *MockmessageRepository) MarkAsVisibleForManager(ctx context.Context, msgID types.MessageID) error {
	m.ctrl.T.Helper()
...
func (mr *MockmessageRepositoryMockRecorder) MarkAsVisibleForManager(ctx, msgID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkAsVisibleForManager", reflect.TypeOf((*MockmessageRepository)(nil).MarkAsVisibleForManager), ctx, msgID)
}
