...
func (m *MockmessageRepository) BlockMessage(ctx context.Context, msgID types.MessageID) error {
	m.ctrl.T.Helper()
...
func (mr *MockmessageRepositoryMockRecorder) BlockMessage(ctx, msgID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BlockMessage", reflect.TypeOf((*MockmessageRepository)(nil).BlockMessage), ctx, msgID)
}
